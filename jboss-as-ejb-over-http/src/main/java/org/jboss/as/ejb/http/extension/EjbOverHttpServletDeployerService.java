...
class EjbOverHttpServletDeployerService implements Service<Context> {
    ...
    private final InjectedValue<HttpEJBRemoteConnectorService> httpEJBRemoteConnectorServiceInjectedValue = new
            InjectedValue<HttpEJBRemoteConnectorService>();
    ...
    InjectedValue<HttpEJBRemoteConnectorService> getHttpEJBRemoteConnectorServiceInjectedValue() {
        return httpEJBRemoteConnectorServiceInjectedValue;
    }
    ...
    private Wrapper prepareServletWrapper() {
        //            EjbOverHttpRemoteServlet httpEJBRemoteServlet = new EjbOverHttpRemoteServlet(null);  // TODO !!!
        org.jboss.as.ejb3.remote.http.HttpEJBRemoteServlet httpEJBRemoteServlet = new org.jboss.as.ejb3.remote.http.HttpEJBRemoteServlet();
