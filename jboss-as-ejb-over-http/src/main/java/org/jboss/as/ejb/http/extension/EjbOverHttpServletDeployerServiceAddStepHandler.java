        ...
        if (context.isNormalServer()) {
            ...
            context.addStep(new OperationStepHandler() {
                ...
                public void execute(OperationContext context, ModelNode operation) {
                    ...
                    ejbOverHttpServletDeployerServiceServiceBuilder.addDependency(HttpEJBRemoteConnectorService.SERVICE_NAME, HttpEJBRemoteConnectorService.class,
                            ejbOverHttpContextService.getHttpEJBRemoteConnectorServiceInjectedValue())
